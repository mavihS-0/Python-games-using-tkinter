...
f=open('resultsofrps.csv','w', newline='')
wr=csv.writer(f)
wr.writerow(['Your Choice:',"Computer's Choice",'Your Score','Computer Score','Result'])
def result(human_choice,comp_choice):
    ...
    if(user==comp):
        print("Tie")
        wr.writerow([USER_CHOICE,COMP_CHOICE,USER_SCORE,COMP_SCORE,'Tie'])
    elif((user-comp)%3==1):
        print("You win")
        USER_SCORE+=1
        wr.writerow([USER_CHOICE,COMP_CHOICE,USER_SCORE,COMP_SCORE,'You won'])
    else:
        print("Comp wins")
        COMP_SCORE+=1
        wr.writerow([USER_CHOICE,COMP_CHOICE,USER_SCORE,COMP_SCORE,'Comp won'])
